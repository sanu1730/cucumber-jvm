...
public class ExecutionUnitRunner extends ParentRunner<PickleStep> {
    ...
    private final GherkinDialect i18n;
    private final JUnitReporter jUnitReporter;
    private final Map<PickleStep, Description> stepDescriptions = new HashMap<PickleStep, Description>();
    private Description description;

    public ExecutionUnitRunner(Runner runner, Pickle pickle, GherkinDialect i18n, JUnitReporter jUnitReporter) throws InitializationError {
    ...
    public Description getDescription() {
        if (description == null) {
            description = Description.createSuiteDescription(getName(), new PickleWrapper(pickle));
