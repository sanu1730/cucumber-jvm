...
public class FeatureRunnerTest {
    ...
    private RunNotifier runFeatureWithNotifier(CucumberFeature cucumberFeature) throws InitializationError {
        ...
        FeatureRunner runner = new FeatureRunner(cucumberFeature, runtime.getRunner(), new JUnitReporter(runtime.getEventBus(), false, new JUnitOptions(Collections.<String>emptyList())));
