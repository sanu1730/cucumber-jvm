...
public class AndroidInstrumentationReporterTest {
    ...
    public void beforeEachTest() {
        when(testCase.getLocation()).thenReturn("path/file.feature:4");
    ...
    public void feature_name_and_keyword_is_contained_in_start_signal() {
        ...
        assertThat(actualBundle.getString(AndroidInstrumentationReporter.StatusKeys.CLASS), containsString(testCase.getLocation()));
    }
